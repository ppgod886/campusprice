...
const EXTRA2 = [
  ...
  ['食品饮料','农夫山泉','饮用水 24 瓶',33.9,'water'],['食品饮料','康师傅','红烧牛肉面 12 连包',39.9,''],
  ['食品饮料','统一','冰红茶 15 瓶',29.9,'can'],['食品饮料','蒙牛','纯牛奶 16 盒',49.9,''],
  ...
  ['食品饮料','农夫山泉','NFC 果汁 1L',29.9,'juice'],['食品饮料','王小卤','虎皮凤爪',39.9,''],
  ['食品饮料','自嗨锅','自热火锅',39.9,'']
];
