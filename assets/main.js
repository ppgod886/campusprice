...
const P = [
  ...
  {id:6, name:'全棉床上三件套', cat:'宿舍生活', emoji:'🛏️', img:'1522771739844-6a9f6d5f14af', base:139,
   sell:'开学必买,睡得好才学得好'},
  {id:7, name:'迷你加湿器', cat:'宿舍生活', emoji:'💧', img:'', base:59,
   sell:'秋冬干燥季宿舍救星'},
  ...
  {id:18, name:'宿舍小电煮锅', cat:'宿舍生活', emoji:'🍲', img:'', base:89,
   sell:'煮面火锅一人食,深夜食堂自由'},
  {id:19, name:'床头挂篮置物架', cat:'宿舍生活', emoji:'🧺', img:'', base:25,
   sell:'上铺党神器,手机零食触手可及'},
...
const EXTRA2 = [
  ...
  ['数码3C','罗技','G304 无线鼠标',199,''],['数码3C','小米','小爱音箱',99,''],
  ['数码3C','闪极','移动电源 2万毫安',129,''],
  ['宿舍生活','网易严选','纯棉四件套',159,'bed'],['宿舍生活','水星家纺','冬被加厚',129,'bed'],
  ['宿舍生活','美的','宿舍小电锅',99,''],['宿舍生活','苏泊尔','电煮锅 1.2L',129,''],
  ['宿舍生活','小熊','煮蛋器',49,''],['宿舍生活','九阳','便携榨汁机',149,''],
  ['宿舍生活','美的','桌面小风扇',89,''],['宿舍生活','飞利浦','LED 台灯',129,'lamp'],
  ...
  ['洗护美妆','高露洁','牙膏三支装',29.9,''],['洗护美妆','舒客','软毛牙刷两支',19.9,''],
  ...
  ['运动出行','匹克','防滑篮球',99,''],['运动出行','京东京造','可拆卸哑铃',59,'gym'],
  ['运动出行','Keep','瑜伽球',39.9,'yoga'],['运动出行','李宁','运动短裤',99,'workout'],
  ['运动出行','安踏','速干训练 T',129,'workout'],['运动出行','匹克','运动袜 5 双',39.9,''],
  ...
  ['生活日用','名创优品','无火香薰',25,''],['生活日用','名创优品','湿巾 80 抽',10,'clean'],
  ['生活日用','悠家良品',' ins 马克杯',29.9,''],['生活日用','苏泊尔','保温饭盒',59.9,''],
  ['生活日用','得力','防风衣架 20 只',16.9,'storage'],['生活日用','乐扣乐扣','玻璃保鲜盒',39.9,''],
  ['食品饮料','良品铺子','零食大礼包',69.9,'candy'],['食品饮料','百草味','猪肉脯 200g',26.9,''],
  ['食品饮料','农夫山泉','饮用水 24 瓶',33.9,''],['食品饮料','康师傅','红烧牛肉面 12 连包',39.9,''],
  ['食品饮料','统一','冰红茶 15 瓶',29.9,''],['食品饮料','蒙牛','纯牛奶 16 盒',49.9,''],
  ['食品饮料','王老吉','凉茶 12 罐',45.9,''],['食品饮料','奥利奥','家庭分享装',19.9,'candy'],
  ['食品饮料','乐吧','薯片 8 包',26.9,'chips'],['食品饮料','盼盼','麦香鸡味块',16.8,'chips'],
  ['食品饮料','洽洽','香瓜子 500g',15.9,'candy'],['食品饮料','旺旺','雪饼家族装',29.9,'candy'],
  ['食品饮料','蒙牛','酸奶 8 杯',39.9,''],['食品饮料','卡士','鲜酪乳 6 杯',45,''],
  ['食品饮料','喜之郎','果冻分享装',49.9,'candy'],['食品饮料','盼盼','软面包 1kg',25,'pancake'],
  ['食品饮料','港荣','蒸蛋糕 1kg',29.9,'pancake'],['食品饮料','良品铺子','软面包 500g',35,'pancake'],
  ['食品饮料','农夫山泉','NFC 果汁 1L',29.9,''],['食品饮料','王小卤','虎皮凤爪',39.9,''],
  ['食品饮料','自嗨锅','自热火锅',39.9,'']
];
